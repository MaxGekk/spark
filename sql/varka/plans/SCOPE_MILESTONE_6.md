...
*Re-scoped on 23 September 2026, when milestone 5 closed. Milestone 6 is the
compiler's foundation and its promotion - `PLAN_MILESTONE_6.md` is its plan -
and **the coverage spine argued for below moves to milestone 7 unchanged**:
decimal lanes, decimal arithmetic, aggregate wiring, grouped aggregation, string
keys, and a first end-to-end TPC-H q6 number. Nothing here is withdrawn. The
