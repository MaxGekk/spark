 ...
 * `invokestatic` with a primitive stack. The argument order below is therefore the
...
public final class DateVectorOps {
   ...
   * mixed-null path (see measured with interleaved A/B runs). Sharing one mask helper
